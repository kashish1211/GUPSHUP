...
from .views import PostDetailView, PostUpdateView, PostDeleteView, UserPostListView, PostLike, SearchResultView, homeForm, CategoryPostListView
from . import views

urlpatterns = [
    path('', views.homeForm, name='blog-home'),
