...
urlpatterns = [
    ...
    path('comment-upvote/<int:pk>/<int:pck>', views.Upvote_comment, name='comment-upvote'),
    path('comment-downvote/<int:pk>/<int:pck>', views.Downvote_comment, name='comment-downvote'),
